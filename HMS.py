...
class hospital:
    def __init__(self,root):
        ...
        DetailsButton=Button(buttonframe,command=self.idetails,text="Details",bg="Black",fg="White",font=("times new roman",12,BOLD),width=20,height=1,padx=2,pady=6)
        DetailsButton.grid(row=0,column=0)

        AddButton=Button(buttonframe,text="Add ",bg="Black",fg="White",font=("times new roman",12,BOLD),command=self.iadd,width=20,height=1,padx=2,pady=6)
        AddButton.grid(row=0,column=1) 

        UpdateButton=Button(buttonframe,text="Update",bg="Black",fg="White",font=("times new roman",13,BOLD),command=self.iupdate,width=20,height=1,padx=2,pady=6)
        UpdateButton.grid(row=0,column=2)

        DeleteButton=Button(buttonframe,text="Delete",bg="Black",fg="White",font=("times new roman",13,BOLD),command=self.idelete,width=20,height=1,padx=2,pady=6)
        DeleteButton.grid(row=0,column=3)

        ClearButton=Button(buttonframe,command=self.iclear,text="Clear",bg="Black",fg="White",font=("times new roman",13,BOLD),width=20,height=1,padx=2,pady=6)
        ClearButton.grid(row=0,column=4)

        ExitButton=Button(buttonframe,command=self.iexit,text="Exit",bg="Black",fg="White",font=("times new roman",13,BOLD),width=20,height=1,padx=2,pady=6)
    ...
    def iadd(self):
        if self.Name.get()=="" or self.Ref.get()=="":
            ...
            self.DoB.get(),self.Pname.get(),self.paddrs.get(),self.suggestion.get()))
            conn.commit()
            self.fetchdata()
